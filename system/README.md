...
#### desktop.config_custom

This directory contains common desktop configuration items that also have target specific configuration parts.

##### <a name="weston.ini_common"></a> weston.ini_common

This file contains weston.ini configuration items that are common amoung all targes.  This will be combined
with target specific configuration items during build time.  Target specific configuration files can be
under the target directory.  The target specific configuration file currently contains qnx specific configurations.
