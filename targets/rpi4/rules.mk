...
$(BUILD)/bsp/install/aarch64le/lib/dll/$(notdir $(1)): $(BUILD)/$(1) | $(BUILD)/built_bsp
	mkdir -p $(BUILD)/bsp/install/aarch64le/lib/dll
	cp $$< $$@
...
$(BUILD)/rpi4.img: $(TARGET_BASE_DEPS) $(BUILD)/built_bsp boot
	...
	QNX_TARGET=$(QNX_TARGET) QNX_ARCHDIR=$(QNX_ARCHDIR) TIME_SERVERS=$(CTI_TIME_SERVERS) CTI_DISABLE_VNCSERV=$(CTI_DISABLE_VNCSERV) \
